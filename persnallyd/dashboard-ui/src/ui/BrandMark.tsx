...
const MARKS: Record<string, { path: string; title: string }> = {
  claude: { path: siClaude.path, title: "Claude" },
  "claude-code": { path: siClaude.path, title: "Claude" },
  ...
  zed: { path: siZedindustries.path, title: "Zed" },
  vscode: { path: VSCODE_PATH, title: "VS Code" },
  git: { path: siGit.path, title: "Git" },
